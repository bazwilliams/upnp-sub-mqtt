DOCKER := bazwilliams/upnp-sub-mqtt
...
define label_dockerfile
	...
	@echo "      org.label-schema.name=\"UPNP to MQTT subscription bridge\" \\" >> $(1)
	...
	@echo "      org.label-schema.vcs-url=\"https://github.com/bazwilliams/upnp-sub-mqtt\" \\" >> $(1)
